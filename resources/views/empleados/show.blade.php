...
@section('title', 'Empleado - ' . $empleado->Nombres . ' ' . $empleado->ApellidoPaterno)
                ...
                <ol role="list" class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-4 text-sm font-medium text-gray-700">{{ $empleado->Nombres }} {{ $empleado->ApellidoPaterno }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <div class="flex items-center space-x-2 mt-1">
                        ...
                        @endif
                        <span class="text-sm text-gray-500">ID: {{ $empleado->IDEmpleado }}</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="border-t border-gray-200">
                    <dl>
                        ...
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">{{ $empleado->CI }}</dd>
                        </div>
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                ...
                                @if($empleado->FechaNacimiento)
                                    <span class="text-gray-500">
                                        ({{ \Carbon\Carbon::parse($empleado->FechaNacimiento)->age }} años)
                                    </span>
                                @endif
                            </dd>
                        </div>
                ...
                <div class="border-t border-gray-200">
                    <dl>
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                @if($empleado->Email)
                                    <a href="mailto:{{ $empleado->Email }}" class="text-blue-600 hover:text-blue-500">
                                        {{ $empleado->Email }}
                                    </a>
                                @else
                        ...
                        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                                @if($empleado->Telefono)
                                    <a href="tel:{{ $empleado->Telefono }}" class="text-blue-600 hover:text-blue-500">
                                        {{ $empleado->Telefono }}
                                    </a>
                                @else
                                    <span class="text-gray-500">No registrado</span>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">{{ $contrato->NombreCargo }}</div>
                                        <div class="text-sm text-gray-500">{{ $contrato->NombreCategoria }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        {{ $contrato->NombreDepartamento }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {{ \Carbon\Carbon::parse($contrato->FechaInicio)->format('d/m/Y') }}
                                        -
                                        {{ $contrato->FechaFin ? \Carbon\Carbon::parse($contrato->FechaFin)->format('d/m/Y') : 'Presente' }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($contrato->Estado)
                                            <span class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">
        ...
        <div class="lg:col-span-1 space-y-6">
                    ...
                    <dl>
                        <div class="bg-gray-50 px-4 py-5">
                            ...
                            <dd class="text-sm text-gray-900">
                                {{ $empleado->departamento->NombreDepartamento ?? 'Sin asignar' }}
                            </dd>
                        </div>
                            ...
                            <dd class="text-sm text-gray-900">
                                ...
                                @if($empleado->FechaIngreso)
                                    <div class="text-xs text-gray-500 mt-1">
                                        {{ \Carbon\Carbon::parse($empleado->FechaIngreso)->diffForHumans() }}
                                    </div>
                                @endif
                            </dd>
                        </div>
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:px-6">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Últimas {{ $planillas->count() }} planillas</p>
                </div>
                <div class="border-t border-gray-200">
