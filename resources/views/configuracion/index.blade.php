...
@section('page-description', 'Configuraciones generales del sistema RRHH')
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm hover:border-gray-400">
                    <div class="flex space-x-3">
                        ...
                        <div class="min-w-0 flex-1">
                            <a href="{{ route('admin.usuarios') }}" class="focus:outline-none">
                                <span class="absolute inset-0" aria-hidden="true"></span>
                ...
                <div class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm hover:border-gray-400">
                    <div class="flex space-x-3">
                        ...
                        <div class="min-w-0 flex-1">
                            <a href="{{ route('configuracion.perfil') }}" class="focus:outline-none">
                                <span class="absolute inset-0" aria-hidden="true"></span>
                ...
                <div class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm hover:border-gray-400">
                    <div class="flex space-x-3">
                        ...
                        <div class="min-w-0 flex-1">
                            <a href="{{ route('admin.sistema') }}" class="focus:outline-none">
                                <span class="absolute inset-0" aria-hidden="true"></span>
        ...
        <div class="p-6">
            <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <dd class="mt-1 text-sm text-gray-900">{{ $_SERVER['SERVER_SOFTWARE'] ?? 'No detectado' }}</dd>
                </div>
                <div>
