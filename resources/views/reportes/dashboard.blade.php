...
@section('page-description', 'Resumen ejecutivo y reportes estadísticos del sistema RRHH')
    ...
    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div class="bg-gray-50 px-5 py-3">
                <div class="text-sm">
                    <a href="{{ route('empleados.index') }}" class="font-medium text-blue-600 hover:text-blue-500">
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div class="bg-gray-50 px-5 py-3">
                <div class="text-sm">
                    <a href="{{ route('contratos.vigentes') }}" class="font-medium text-green-600 hover:text-green-500">
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">Planillas {{ date('m/Y') }}</dt>
            ...
            <div class="bg-gray-50 px-5 py-3">
                <div class="text-sm">
                    <a href="{{ route('planillas.index', ['gestion' => date('Y'), 'mes' => date('n')]) }}" class="font-medium text-amber-600 hover:text-amber-500">
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">Nómina {{ date('m/Y') }}</dt>
            ...
            <div class="bg-gray-50 px-5 py-3">
                <div class="text-sm">
                    <a href="{{ route('planillas.reportes') }}" class="font-medium text-purple-600 hover:text-purple-500">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <div class="mt-2">
                            <a href="{{ route('contratos.alertas') }}" class="text-sm font-medium text-amber-600 hover:text-amber-500">
                                Ver detalles →
                            </a>
                        </div>
                    </div>
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <div class="mt-2">
                            <a href="{{ route('planillas.index', ['estado_pago' => 'Pendiente']) }}" class="text-sm font-medium text-red-600 hover:text-red-500">
                                Revisar planillas →
                            </a>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm hover:border-gray-400">
                    <div class="flex space-x-3">
                        ...
                        <div class="min-w-0 flex-1">
                            <a href="{{ route('empleados.index') }}" class="focus:outline-none">
                ...
                <div class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm hover:border-gray-400">
                    <div class="flex space-x-3">
                        ...
                        <div class="min-w-0 flex-1">
                            <a href="{{ route('contratos.index') }}" class="focus:outline-none">
                                <span class="absolute inset-0" aria-hidden="true"></span>
                ...
                <div class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm hover:border-gray-400">
                    <div class="flex space-x-3">
                        ...
                        <div class="min-w-0 flex-1">
                            <a href="{{ route('planillas.reportes') }}" class="focus:outline-none">
                                <span class="absolute inset-0" aria-hidden="true"></span>
                ...
                <div class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm hover:border-gray-400">
                    <div class="flex space-x-3">
                        ...
                        <div class="min-w-0 flex-1">
                            <a href="{{ route('planillas.generar') }}" class="focus:outline-none">
                                <span class="absolute inset-0" aria-hidden="true"></span>
                ...
                <div class="relative rounded-lg border border-gray-300 bg-white px-6 py-5 shadow-sm hover:border-gray-400">
                    <div class="flex space-x-3">
                        ...
                        <div class="min-w-0 flex-1">
                            <a href="{{ route('contratos.alertas') }}" class="focus:outline-none">
                                <span class="absolute inset-0" aria-hidden="true"></span>
