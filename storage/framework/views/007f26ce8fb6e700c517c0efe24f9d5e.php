...
<?php $__env->startSection('title', 'Contratos Vigentes'); ?>
<?php $__env->startSection('page-title', 'Contratos Vigentes'); ?>
<?php $__env->startSection('page-description', 'Lista de todos los contratos activos y vigentes en el sistema'); ?>

<?php $__env->startSection('content'); ?>
<div class="space-y-6">
    
    <!-- Debug temporal (remover en producción) -->
    <?php if(isset($stats['debug']) && config('app.debug')): ?>
    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        <h4 class="text-sm font-medium text-yellow-800">Debug Info (solo desarrollo)</h4>
        <div class="mt-2 text-sm text-yellow-700">
            <p>Contratos con fecha de fin: <?php echo e($stats['debug']['total_con_fecha_fin']); ?></p>
            <p>Fecha actual: <?php echo e($stats['debug']['fecha_actual']); ?></p>
            <p>Fecha límite (30d): <?php echo e($stats['debug']['fecha_limite']); ?></p>
            <p>Por vencer calculado: <?php echo e($stats['por_vencer']); ?></p>
            <?php if($stats['debug']['ejemplos_fechas']->count() > 0): ?>
                <p>Ejemplos de fechas de fin:</p>
                <ul class="list-disc list-inside ml-2">
                    <?php $__currentLoopData = $stats['debug']['ejemplos_fechas']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ejemplo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li><?php echo e($ejemplo->NumeroContrato); ?>: <?php echo e($ejemplo->FechaFin); ?></li>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e($stats['total_vigentes'] ?? 0); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e($stats['indefinidos'] ?? 0); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e($stats['por_vencer'] ?? 0); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">
                                Bs <?php echo e(number_format($stats['nomina_total'] ?? 0, 2)); ?>
                        ...
                        <?php $__currentLoopData = $contratos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contrato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                    ...
                                    <div class="text-sm text-gray-500">
                                        <?php if($contrato->FechaFin): ?>
                                            ...
                                            <?php if($diasRestantes <= 30 && $diasRestantes >= 0): ?>
                                                <span class="text-xs text-amber-600 font-medium">(<?php echo e($diasRestantes); ?> días)</span>
                                            <?php endif; ?>
                                        <?php else: ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <div class="text-xs text-gray-500"><?php echo e($contrato->TipoContrato); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">
                                        Vigente
                                    </span>
                                    <?php if($contrato->FechaFin && \Carbon\Carbon::parse($contrato->FechaFin)->between(now(), now()->addDays(30))): ?>
                                        <div class="mt-1">
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        <div>
                            <p class="text-sm text-gray-700">
                                Mostrando <span class="font-medium"><?php echo e($contratos->firstItem()); ?></span> a <span class="font-medium"><?php echo e($contratos->lastItem()); ?></span> de <span class="font-medium"><?php echo e($contratos->total()); ?></span> contratos vigentes
                            </p>
                        </div>
                        <div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/contratos/vigentes.blade.php ENDPATH**/ ?>