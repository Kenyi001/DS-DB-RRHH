...
<div x-data="planillasData()" x-init="loadData()" class="space-y-6">
    ...
    <?php if(isset($stats) && $stats['total_planillas'] > 0): ?>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo e(number_format($stats['total_planillas'])); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">Bs <?php echo e(number_format($stats['total_nomina'], 2)); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">Bs <?php echo e(number_format($stats['promedio_sueldo'], 2)); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-sm text-gray-900">
                                <span class="text-green-600"><?php echo e($stats['pagadas']); ?> pagadas</span> / 
                                <span class="text-amber-600"><?php echo e($stats['pendientes']); ?> pendientes</span>
                            </dd>
                        </dl>
                    </div>
                </div>
    ...
    <div class="bg-white shadow rounded-lg">
        <div class="p-6">
            <form method="GET" action="<?php echo e(route('planillas.index')); ?>" class="space-y-4 lg:space-y-0 lg:grid lg:grid-cols-5 lg:gap-4">
                ...
                <div>
                    ...
                    <select name="gestion" id="gestion" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                        <?php $__currentLoopData = $gestiones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gestion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($gestion); ?>" <?php echo e(($filtros['gestion'] ?? '') == $gestion ? 'selected' : ''); ?>>
                                <?php echo e($gestion); ?>
                ...
                <div>
                    ...
                    <select name="estado_pago" id="estado_pago" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
                        <option value="">Todos</option>
                        <option value="Pendiente" <?php echo e(($filtros['estado_pago'] ?? '') == 'Pendiente' ? 'selected' : ''); ?>>Pendientes</option>
                        <option value="Pagado" <?php echo e(($filtros['estado_pago'] ?? '') == 'Pagado' ? 'selected' : ''); ?>>Pagados</option>
                    </select>
                </div>
                ...
                <div class="lg:col-span-5 flex justify-between items-end space-x-3">
                    ...
                    <div class="text-sm text-gray-500">
                        Total: <?php echo e($planillas->total()); ?> planillas
                    </div>
                </div>
            </form>
        </div>
        ...
        <?php if($planillas->count() > 0): ?>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $planillas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $planilla): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                    ...
                                    <div class="flex items-center">
                                        <div class="h-10 w-10 flex-shrink-0">
                                            <div class="h-10 w-10 rounded-full bg-purple-100 flex items-center justify-center">
                                                <span class="text-sm font-medium text-purple-600">
                                                    <?php echo e(substr($planilla->contrato->empleado->Nombres, 0, 1)); ?><?php echo e(substr($planilla->contrato->empleado->ApellidoPaterno, 0, 1)); ?>
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900">
                                                <?php echo e($planilla->contrato->empleado->Nombres); ?> <?php echo e($planilla->contrato->empleado->ApellidoPaterno); ?>

                                            </div>
                                            <div class="text-sm text-gray-500">
                                                <?php echo e($planilla->contrato->empleado->ApellidoMaterno); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">
                                        <?php echo e(str_pad($planilla->Mes, 2, '0', STR_PAD_LEFT)); ?>/<?php echo e($planilla->Gestion); ?>

                                    </div>
                                    <div class="text-sm text-gray-500">
                                        <?php echo e(\Carbon\Carbon::createFromFormat('n', $planilla->Mes)->locale('es')->monthName); ?> <?php echo e($planilla->Gestion); ?>

                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    Bs <?php echo e(number_format($planilla->SalarioBasico, 2)); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    Bs <?php echo e(number_format($planilla->TotalIngresos, 2)); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-red-600">
                                    Bs <?php echo e(number_format($planilla->TotalDescuentos, 2)); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php if($planilla->EstadoPago === 'Pagado'): ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        <a href="<?php echo e(route('planillas.show', $planilla->IDGestionSalario)); ?>" 
                                        ...
                                        <?php if($planilla->EstadoPago !== 'Pagado'): ?>
                                            <button @click="marcarComoPagado(<?php echo e($planilla->IDGestionSalario); ?>)" 
            ...
            <div class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
                <div class="flex-1 flex justify-between sm:hidden">
                    <?php if($planillas->previousPageUrl()): ?>
                        <a href="<?php echo e($planillas->previousPageUrl()); ?>" class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                            Anterior
                        </a>
                    <?php endif; ?>
                    <?php if($planillas->nextPageUrl()): ?>
                        <a href="<?php echo e($planillas->nextPageUrl()); ?>" class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                            Siguiente
                        </a>
                    <?php endif; ?>
                </div>
                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div>
                        <p class="text-sm text-gray-700">
                            Mostrando
                            <span class="font-medium"><?php echo e($planillas->firstItem()); ?></span>
                            a
                            <span class="font-medium"><?php echo e($planillas->lastItem()); ?></span>
                            de
                            <span class="font-medium"><?php echo e($planillas->total()); ?></span>
                            planillas
                        </p>
                    </div>
                    <div>
        ...
        <?php else: ?>
            ...
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    <?php if(request()->hasAny(['search', 'gestion', 'mes', 'estado_pago', 'empleado_id'])): ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/planillas/index.blade.php ENDPATH**/ ?>