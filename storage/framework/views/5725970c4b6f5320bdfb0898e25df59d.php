...
<?php $__env->startSection('title', 'Generar Planillas'); ?>
...
<div x-data="generarPlanillasData()" x-init="init()" class="space-y-6">
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-amber-700">
                        <p>
                            Ya existen <?php echo e($planillasExistentes); ?> planillas generadas para <?php echo e(str_pad($mesActual, 2, '0', STR_PAD_LEFT)); ?>/<?php echo e($gestionActual); ?>. 
    ...
    <form method="POST" action="<?php echo e(route('planillas.generar.post')); ?>" class="space-y-8">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <select name="mes" 
                                    id="mes" 
                                    required
                                    class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm <?php $__errorArgs = ['mes'];
...
unset($__errorArgs, $__bag); ?>">
                                <option value="1" <?php echo e(old('mes', $mesActual) == '1' ? 'selected' : ''); ?>>Enero</option>
                                <option value="2" <?php echo e(old('mes', $mesActual) == '2' ? 'selected' : ''); ?>>Febrero</option>
                                <option value="3" <?php echo e(old('mes', $mesActual) == '3' ? 'selected' : ''); ?>>Marzo</option>
                                <option value="4" <?php echo e(old('mes', $mesActual) == '4' ? 'selected' : ''); ?>>Abril</option>
                                <option value="5" <?php echo e(old('mes', $mesActual) == '5' ? 'selected' : ''); ?>>Mayo</option>
                                <option value="6" <?php echo e(old('mes', $mesActual) == '6' ? 'selected' : ''); ?>>Junio</option>
                                <option value="7" <?php echo e(old('mes', $mesActual) == '7' ? 'selected' : ''); ?>>Julio</option>
                                <option value="8" <?php echo e(old('mes', $mesActual) == '8' ? 'selected' : ''); ?>>Agosto</option>
                                <option value="9" <?php echo e(old('mes', $mesActual) == '9' ? 'selected' : ''); ?>>Septiembre</option>
                                <option value="10" <?php echo e(old('mes', $mesActual) == '10' ? 'selected' : ''); ?>>Octubre</option>
                                <option value="11" <?php echo e(old('mes', $mesActual) == '11' ? 'selected' : ''); ?>>Noviembre</option>
                                <option value="12" <?php echo e(old('mes', $mesActual) == '12' ? 'selected' : ''); ?>>Diciembre</option>
                            </select>
                            <?php $__errorArgs = ['mes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="number" 
                                   name="gestion" 
                                   id="gestion" 
                                   value="<?php echo e(old('gestion', $gestionActual)); ?>"
                                   min="2020" 
                                   max="<?php echo e(now()->year + 1); ?>"
                                   required
                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md <?php $__errorArgs = ['gestion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-300 <?php unset($message);
                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    ...
                    <div class="max-h-96 overflow-y-auto border border-gray-200 rounded-md">
                        <div class="divide-y divide-gray-200">
                            <?php $__currentLoopData = $empleadosActivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $empleado): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="p-3 hover:bg-gray-50 employee-item" 
                                     data-name="<?php echo e(strtolower($empleado->Nombres . ' ' . $empleado->ApellidoPaterno . ' ' . $empleado->ApellidoMaterno)); ?>"
                                     data-department="<?php echo e(strtolower($empleado->NombreDepartamento)); ?>">
                                    <label class="flex items-center space-x-3">
                                        <input type="checkbox" 
                                               name="empleados[]" 
                                               value="<?php echo e($empleado->IDEmpleado); ?>"
                                               @change="updateSelection()"
                                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded employee-checkbox"
                                               <?php echo e(in_array($empleado->IDEmpleado, old('empleados', [])) ? 'checked' : ''); ?>>
                                            ...
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    ...
                                                    <div class="text-sm text-gray-500">
                                                        <?php echo e($empleado->NombreCargo); ?> - <?php echo e($empleado->NombreDepartamento); ?>

                                                    </div>
                                                </div>
                                                <div class="text-sm text-gray-900">
                                                    Bs <?php echo e(number_format($empleado->HaberBasico, 2)); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/planillas/generar.blade.php ENDPATH**/ ?>